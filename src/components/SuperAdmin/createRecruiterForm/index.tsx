...
const CreateRecruiterForm = () => {
  ...
  return (
    <div>
      <span className="flex justify-content-between p-5"><span className="text-2xl">Create Recruiters</span> <span><i className="pi pi-pencil"></i><span className="ml-2 font-semibold">Edit</span></span></span>
      <div>
        <span className="ml-5 mt-5"> <img src={noavathar} style={{width: '130px'}}></img> 
        </span>
