    ...
    <div className="p-2 flex justify-content-between align-items-center NavBar_Main">
      <section className="flex NavBar_Division  align-items-center">
        ...
        <section className="flex">
          ...
          <span className='nav_text  flex align-items-center mt-2 white-space-nowrap ml-2'>{displayNav}</span>
          {state
            ...
            <i className="pi pi-angle-double-right mr-6 mt-4"></i></div>
            <OverlayPanel
            ref={op}
            showCloseIcon
            id="overlay_panel"
          ...
          >
            ...
            <span className="p-input-icon-left">
                    ...
                    <InputText value={value3} onChange={(e) => setValue3(e.target.value)} placeholder="Search" style={{width: '148px'}}/>
                </span>
                ...
                return (
                  ...
                  >
                    <div className=''>
                      ...
                      {index >= 0 ? (
                        <div>
                        <div className="nav_text_overlay" onClick={()=>ShowNav(x.modulename)}>{x.modulename} </div>
            ...
            <div className='mt-5 cursor-pointer text-primary' onClick={NextPage}> + Create New Module </div>
            </div>
          </OverlayPanel>
          {/*  
          <div
