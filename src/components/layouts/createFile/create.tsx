...
const UntitleImage = () => {
  ...
  return (
    <div>
      ...
      >
        <div className='mt-6'>
          <span className='text-2xl font-bold fixed top-0 mt-3'>Set Permission</span>
...
<span className='mr-6'><RadioButton inputId="Read and Write  All" name="city" value="Read and Write  All" onChange={(e) => setCity(e.value)} checked={city === 'Read and Write  All'} /></span>
