...
const submitHandler = async() =>{
  ...
  console.log(Number1,"setNumber1")
      ...
      >
        <div className="field col-12 md:col-3" >
                    ...
                    <div className="field col-12 md:col-3" style={{width: '35%'}}>
                        ...
                        <InputNumber inputId="Maximum digits allowed" value={Number1} onValueChange={(e:any) => setNumber1(e.value)} showButtons  mode="decimal" min={0} max={16} />
                    </div>
       
       
         <div className="field col-12 md:col-3" style={{width: '35%'}}>
                        <label htmlFor="Number of decimal places">Number of decimal places</label>
                        <InputNumber inputId="Number of decimal places" value={Number2} onValueChange={(e:any) => setNumber2(e.value)} showButtons  mode="decimal" min={0} max={9} />
                    </div>
                    
        <h5>Rounding Option</h5>
        <div className="flex">
          <span>
                <Dropdown value={selectedCity1} options={cities} onChange={onCityChange} optionLabel="name" placeholder="Select a City" /></span>
                {selectedCity1.name != 'Normal'  ? <div className="field col-12 md:col-3 pop" >
                <h5>Precision</h5>
                <InputNumber inputId="Number of decimal places" value={Number3} onValueChange={(e:any) => setNumber3(e.value)} showButtons  mode="decimal" min={0} max={9} />
            </div>
                :""}
            </div>
        ...
        <div className="field-checkbox mt-2">
         ...
         {checked1?<p className="surface-300 p-1">Read/Write permissions will be given to all the profiles with access to this module.</p>:""}

          

          <div className="field-checkbox">
                    <Checkbox inputId="binary" checked={checked2} onChange={e => setChecked2(e.checked)} />
